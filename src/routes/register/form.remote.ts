...
export const register = form(
  ...
  (data): Effect.Effect<never, FormResponseError, RequestEvent> =>
    Effect.gen(function* () {
      const db = yield* ORM;
      ...
      yield* db.insert(table.user).values(newUser).pipe(sqlErrorToServerError);
      ...
      return yield* new Redirect({ to: resolve("/profile/edit"), code: 302 });
